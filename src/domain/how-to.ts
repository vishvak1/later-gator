...
export const HOW_TO_PANELS: readonly { id: string; kicker: string; title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: `<p class="muted">Later Gator uses OAuth, so you never copy a secret token. The assistant opens Later Gator, you enter your existing password if needed, and you approve read-only access.</p>
      <h3>ChatGPT</h3>
      <ol class="setup-steps">
        ...
        <li><strong>Approve read-only access.</strong><span>ChatGPT redirects to Later Gator. Sign in with your Later Gator password and select Connect ChatGPT.</span></li>

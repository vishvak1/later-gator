...
describe("Worker foundation", () => {
  ...
  it("serves an unauthenticated login page at the root", async () => {
    ...
    // The reveal control is what makes a password typed into a fresh
    // deployment checkable before it becomes the only way in.
    expect(html).toContain('id="loginReveal"');
  });

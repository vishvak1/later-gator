...
/** Decodes entities for page-content resolution. */
...
/** Collapses whitespace for page-content resolution. */
export function collapseWhitespace(value: string): string {
  return value.replace(/\s+/gu, " ").trim();
}

/** Removes tags for page-content resolution. */
function stripTags(html: string): string {
  return collapseWhitespace(decodeEntities(html.replace(/<[^>]*>/gu, " ")));
}

/** Reads and decodes a named metadata value from fetched HTML. */
...
/** Extracts bounded readable text from HTML for evidence-grounded organization. */
...
/** Removes link only content for page-content resolution. */
...
/** Returns whether primary page content for page-content resolution. */
...
/** Returns whether x status url for page-content resolution. */
...
/** Returns whether x internal url for page-content resolution. */
export function isXInternalUrl(rawUrl: string): boolean {
  try {
...
/** Resolves x post for page-content resolution. */

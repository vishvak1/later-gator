  ...
  const prompt = [
    input.fullPromptOverride ??
      [
        ...
        'Return only one JSON object with exactly these fields: {"tags":["topic"],"description":"concise description","folder":"Social Posts | Articles | Videos & Talks | Code | Docs & Reference | Papers | Websites & Apps","confidence":"high | medium | low","notes":""}.',
        "Leave notes as an empty string unless a low-confidence decision needs a short explanation.",
      ].join("\n"),

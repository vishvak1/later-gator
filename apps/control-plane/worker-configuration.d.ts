/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a47e9a6dcba35d21aabeb6c779fa1196)
// Runtime types generated with workerd@1.20260722.1 2026-08-19 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	CONTROL_DB: D1Database;
	RELEASE_ARTIFACTS: Fetcher;
	ENVIRONMENT: "production";
	PUBLIC_ORIGIN: "https://latergator.app";
	CLOUDFLARE_OIDC_ISSUER: "https://dash.cloudflare.com";
	CONTROL_SESSION_TTL_SECONDS: "43200";
	CHROME_EXTENSION_IDS: "";
	ACTIVE_RUNTIME_RELEASE: "1.0.0";
	ROLLOUT_COHORT_CEILING: "1";
	ROLLOUT_FAILURE_THRESHOLD_PERCENT: "10";
	CLOUDFLARE_IDENTITY_CLIENT_ID: string;
	CLOUDFLARE_IDENTITY_CLIENT_SECRET: string;
	CLOUDFLARE_ACCESS_TEAM_DOMAIN: string;
	CLOUDFLARE_ACCESS_AUD: string;
	INSTALLER_TOKEN_ENCRYPTION_KEY: string;
	OWNER_ASSERTION_SIGNING_KEYS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PUBLIC_ORIGIN" | "CLOUDFLARE_OIDC_ISSUER" | "CONTROL_SESSION_TTL_SECONDS" | "CHROME_EXTENSION_IDS" | "ACTIVE_RUNTIME_RELEASE" | "ROLLOUT_COHORT_CEILING" | "ROLLOUT_FAILURE_THRESHOLD_PERCENT" | "CLOUDFLARE_IDENTITY_CLIENT_ID" | "CLOUDFLARE_IDENTITY_CLIENT_SECRET" | "CLOUDFLARE_ACCESS_TEAM_DOMAIN" | "CLOUDFLARE_ACCESS_AUD" | "INSTALLER_TOKEN_ENCRYPTION_KEY" | "OWNER_ASSERTION_SIGNING_KEYS">> {}
}

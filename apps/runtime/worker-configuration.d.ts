/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5042b77ed6686127245f2bdd4fe9ef2e)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	THUMBNAILS: KVNamespace;
	...
	TIMEZONE: "UTC";
	PUBLIC_ORIGIN: "https://replace-during-provisioning.invalid";
	CONTROL_PLANE_ORIGIN: "https://latergator.app";
	INSTALLATION_ID: "replace-during-provisioning";
	INSTANCE_MASTER_KEY: string;
	LIBRARY_EVENTS: DurableObjectNamespace<import("./src/index").LibraryEvents>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LibraryEvents";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "TIMEZONE" | "PUBLIC_ORIGIN" | "CONTROL_PLANE_ORIGIN" | "INSTALLATION_ID" | "INSTANCE_MASTER_KEY">> {}
}
